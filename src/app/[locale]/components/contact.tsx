...
export function ContactSection() {
  ...
  return (
    <Section id="contact" className="bg-white min-h-[60vh] md:min-h-[80vh]">
      <SectionHeader>
        <Title size="5xl" color="dark-orange">
          {translate('title')}
        </Title>
      </SectionHeader>
        ...
        >
          {contactLinks.map((link) => (
            <Link key={link.href} href={link.href} legacyBehavior passHref>
              <a
                target="_blank"
                className="flex items-center gap-5 text-lg md:text-xl text-dark-orange duration-300 hover:-translate-y-[4px] hover:text-black"
              >
